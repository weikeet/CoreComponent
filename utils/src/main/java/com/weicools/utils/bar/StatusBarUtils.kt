...
package com.weicools.utils.bar
 ...
 * https://juejin.cn/post/6844903709504176135
 */
object StatusBarUtils {
  const val DEFAULT_STATUS_BAR_ALPHA = 112

  private const val TAG_KEY_HAVE_SET_OFFSET = -123
  private const val FAKE_STATUS_BAR_VIEW_ID = -123
  private const val FAKE_TRANSLUCENT_VIEW_ID = -123
   ...
   */
  fun setColor(activity: Activity, @ColorInt color: Int, @IntRange(from = 0, to = 256) statusBarAlpha: Int) {
